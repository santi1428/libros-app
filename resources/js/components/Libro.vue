<template>
    <tr>        
        ...
        <td>{{libro.paginas}}</td>
        <td>
            <button class="btn btn-sm btn-success mb-2" title="Agregar" @click="agregarLibro(libro)"><i class="fas fa-plus"></i></button>
            <button class="btn btn-sm btn-primary" title="Ver"><i class="fas fa-eye"></i></button>
        </td>
    </tr>
</template>
